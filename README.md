...
[![Go Report Card](https://goreportcard.com/badge/github.com/evocrawl/html-to-markdown)](https://goreportcard.com/report/github.com/evocrawl/html-to-markdown)
[![codecov](https://codecov.io/gh/evocrawl/html-to-markdown/branch/master/graph/badge.svg)](https://codecov.io/gh/evocrawl/html-to-markdown)
![GitHub MIT License](https://img.shields.io/github/license/evocrawl/html-to-markdown)
[![GoDoc](https://godoc.org/github.com/evocrawl/html-to-markdown?status.png)](http://godoc.org/github.com/evocrawl/html-to-markdown)
...
```
go get github.com/evocrawl/html-to-markdown
```
...
For all the possible options look at [godocs](https://godoc.org/github.com/evocrawl/html-to-markdown/#Options) and for a example look at the [example](/examples/options/main.go).
...
```go
import "github.com/evocrawl/html-to-markdown/plugin"
...
These are the plugins located in the [plugin folder](/plugin) which you can use by importing "github.com/evocrawl/html-to-markdown/plugin".
...
[Godoc](https://godoc.org/github.com/evocrawl/html-to-markdown)
